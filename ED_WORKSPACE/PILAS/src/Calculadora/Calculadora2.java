...
public class Calculadora2 {
    ...
    public static boolean revisaTodo(String infijo){
        ...
        //Si la pila no esta vacía significa que un paréntesis no se cerro por lo que está incorrecto
        if(!pila.isEmpty())
            res = false;
    ...
    public static void main(String[] args) {
        System.out.println(revisaTodo("(5+6.8)"));
        System.out.println(resolver("-7+(-38+57)*5"));
    }
