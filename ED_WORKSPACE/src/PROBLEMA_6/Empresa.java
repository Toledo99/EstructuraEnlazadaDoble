...
public class Empresa {
    ...
    //3)REPORTE DE OPERARIOS:
    public String reporteOperarios(){
        String str="";
        
        for(int i=0; i<numOperarios; i++)
            str=datosOperarios[i].getNombreEmpleado()+": "+datosOperarios[i].getSueldoBase();
        
        return str;
    }
    
    //4)ACTUALIZACION DE SUELDO PARA ADMINISTRATIVO:
    ...
    //5)CAMBIO DE DEPARTAMENTO PARA EMPLEADOS ADMINISTRATIVOS:
    ...
    //7)REPORTE SUELDO ADMINISTRATIVOS
    public String reporteSueldoAdministrativos(){
        String str="";
